...
function AppWrapper() {
  ...
  return (
    <div className="App">
      ...
      {location.pathname !== "/reels" && location.pathname !== "/report" && location.pathname !== "/notifications" && location.pathname !== "/news" && location.pathname !== "/dashboard" && location.pathname !== "/friends" && !location.pathname.startsWith("/messages") && <Navbar />}
      <Routes>
